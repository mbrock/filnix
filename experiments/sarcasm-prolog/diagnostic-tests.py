...
cases = [
    ...
    ("orphan-annotation", "#! ptr\n", "orphan_pointer_annotation"),
    ("annotation-syntax", "movq (%rdi),%r8 #! integer\n", "pointer_annotation_syntax"),
    ("annotated-opcode", "movl (%rdi),%eax #! ptr\n", "pointer_access_requires_movq"),
    ("annotated-immediate", "movq $1,(%rdi) #! ptr\n", "pointer_memory_operands"),
